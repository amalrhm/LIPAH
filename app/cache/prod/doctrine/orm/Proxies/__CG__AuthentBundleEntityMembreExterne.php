 ...
 */
class MembreExterne extends \AuthentBundle\Entity\MembreExterne implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'cin', 'date_naiss', 'email', 'lieu_naiss', 'nationalite', 'nom', 'prenom', 'profil', 'sexe', 'tel', 'listeDesTheses', 'labo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MembreExterne $proxy) {
