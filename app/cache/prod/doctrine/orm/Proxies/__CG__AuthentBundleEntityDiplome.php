 ...
 */
class Diplome extends \AuthentBundle\Entity\Diplome implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'idDiplome', 'libelle', 'institution', 'jury', 'annee', 'membre', 'types');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Diplome $proxy) {
