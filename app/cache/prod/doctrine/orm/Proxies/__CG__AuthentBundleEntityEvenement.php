 ...
 */
class Evenement extends \AuthentBundle\Entity\Evenement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'idEvent', 'date', 'intitule', 'description', 'programme', 'administrateur');
        }
    ...
    public function setIdEvent($idEvent)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdEvent', array($idEvent));
