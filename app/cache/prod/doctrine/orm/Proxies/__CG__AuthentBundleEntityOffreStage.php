 ...
 */
class OffreStage extends \AuthentBundle\Entity\OffreStage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'idOffre', 'domaine', 'periode', 'sujet', 'administrateur');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OffreStage $proxy) {
