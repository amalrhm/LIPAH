 ...
 */
class Labo extends \AuthentBundle\Entity\Labo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'idLabo', 'desc', 'libelle', 'pays', 'membres', 'universites');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Labo $proxy) {
    ...
    public function setIdLabo($idLabo)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdLabo', array($idLabo));

        return parent::setIdLabo($idLabo);
    }
    ...
    public function getIdLabo()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdLabo();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdLabo', array());

        return parent::getIdLabo();
    }
    ...
    public function addUniversite(\AuthentBundle\Entity\Universite $universites)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addUniversite', array($universites));

        return parent::addUniversite($universites);
    }
    ...
    public function removeUniversite(\AuthentBundle\Entity\Universite $universites)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeUniversite', array($universites));

        return parent::removeUniversite($universites);
    }
    ...
    public function getUniversites()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUniversites', array());

        return parent::getUniversites();
    }
