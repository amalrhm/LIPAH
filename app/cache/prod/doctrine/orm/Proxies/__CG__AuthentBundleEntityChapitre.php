 ...
 */
class Chapitre extends \AuthentBundle\Entity\Chapitre implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'idChap', 'libelle', 'desc', 'url', 'cours');
        }
    ...
    public function getIdChap()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdChap();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdChap', array());

        return parent::getIdChap();
    }
